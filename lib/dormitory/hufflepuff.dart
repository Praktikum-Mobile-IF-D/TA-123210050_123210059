...
class HufflepuffPage extends StatefulWidget {
  ...
  HufflepuffPage({required this.email});
  @override
...
class _HufflepuffPageState extends State<HufflepuffPage> {
  ...
  Future<void> fetchCharacters() async {
    final response = await http.get(Uri.parse('https://hp-api.onrender.com/api/characters/house/hufflepuff'));
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: <Widget>[
            Text(
              'Welcome to',
              style: TextStyle(fontSize: 18, color :  Color(0xFF372E29)),
            ),
            Text(
              'Hufflepuff',
              style: TextStyle(fontSize: 21, fontWeight: FontWeight.bold, color:  Color(0xFF372E29)),
            ),
          ],
        ),
        backgroundColor: Color(0xFFEEB935),
        actions: [
          IconButton(
            icon: Icon(Icons.logout, color:  Color(0xFF372E29)),
            onPressed: () async {
              SharedPreferences prefs = await SharedPreferences.getInstance();
      ...
      body: Container(
        ...
        child: isLoading
          ...
          children: [
            ...
            Text(
              'Popular Characters',
              style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color:  Color(0xFF372E29)),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.bold, color:  Color(0xFF372E29)),
                                  textAlign: TextAlign.center,
                                ),
                              ],
                            ),
      ...
      child: ListTile(
        title: Column(
          children: [
            ...
            Text(
              title,
              style: TextStyle(color: Color(0xFF372E29)),
            ),
          ],
        ),
        onTap: () {
